...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.92\linewidth]{hero_figure.png}
...
On the A10G, FP16 reaches \~76\% peak DRAM throughput while INT4 reaches
\~27\%, consistent with a shift from bandwidth-dominated FP16 to a mixed regime.
...
In our sweep, the transition occurs near $\alpha \approx 8$ FLOPs/byte.
...
Equivalently, INT4 helps when arithmetic intensity exceeds a threshold $\alpha$
for the target shape family.
}}
\end{center}
